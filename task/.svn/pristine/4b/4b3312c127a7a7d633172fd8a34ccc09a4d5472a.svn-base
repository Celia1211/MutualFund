...
<section class="tab-content">
  ...
  <article class="tab-pane" id="deposit">
      ...
      <div class="alert alert-info alert-dismissable">
      	<i class="fa fa-info"></i>
        You can not deposit a check of more than <b>$100,000</b> into this account.
      </div>
      </font>
      <div class="content">
	  <p>Amount:</p>
	  <form class="hei " action="depositCheck" method = "post" >
	  	<div class="input-group">
			<span class="input-group-addon">$</span> 
			<input type = "hidden" name = "customerId" value="${customer.id }" />
			<input type="text" class="form-control" name="depositamount" placeholder="Upto 2 decimal digits"
				 maxlength="100" pattern="^[0-9]*\.?[0-9]{0,2}$" style="text-align:right"/>
