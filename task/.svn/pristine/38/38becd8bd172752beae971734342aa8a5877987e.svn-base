...
<section class="tab-content">
  <article class="tab-pane" id="custinfo">
    ...
    ( Pending Money:<fmt:formatNumber value="${pendingCash }"
  ...
  <article class="tab-pane" id="requestCheck">
	 <div class="alert alert-info alert-dismissable">
     	...
     	type="currency" currencySymbol="$"/> so you can only 
     	request check within the available cash balance amount. Besides, you have
