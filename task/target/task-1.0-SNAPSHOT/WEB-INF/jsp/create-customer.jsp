	...
	<form method="post" action="createCustomer" id="form" class="hei">
			...
			<div class="form-group">
				<label for="username">*UserName:</label> <input type="text"
					class="form-control" placeholder="User name should be a valid email address." name="userName"
			...
			<div class="form-group">
				<input type="text" class="form-control" placeholder="line 2 (optional)"
			...
			<div class="form-group">
				<label>*City:</label> <input type="text" class="form-control"
					placeholder="City" name="city" value="${fn:escapeXml(param.city)}" />
			</div>
			<div class="form-group">
